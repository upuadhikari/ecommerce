...
<div class="container">
<a href="/cpanel/products"><div style="color:#c4c4c4;margin-top:10px;"><i class="fas fa-arrow-circle-left"></i> back</div></a>
</div>
...
<div class="create-ad">
  <div class="content">
     ...
     <div class="col-md-4">
         <form method="POST" action="/cpanel/products/{{ $item->product_id }}" enctype="multipart/form-data">
           @csrf
